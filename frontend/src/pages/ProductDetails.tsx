...
const ProductDetails = () => {
    ...
    // Update thumbnail when product changes
    useEffect(() => {
        if (product?.image?.[0]) {
    ...
    return product && (
        <div className="mt-[90px]">
            ...
            <div className="flex flex-col items-center mt-20">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 md:gap-6 mt-6 w-full">
