...
import uploadimg from "../../assets/assets/upload_area.png"
                    ...
                    <div className="flex flex-wrap items-center gap-3 mt-2">
                        {Array(4).fill('').map((_, index) => (
                            <label key={index} htmlFor={`image${index}`}>
                                ...
                                <img className="max-w-24 cursor-pointer" src={files[index] ? URL.createObjectURL(files[index]) : uploadimg} alt="uploadArea" width={100} height={100} />
                            </label>
                        ))}
                    </div>
                </div>
