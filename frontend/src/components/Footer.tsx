import { footerLinks } from "../assets/assets/assets"
        ...
        <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-24 bg-[#4fbf8b]/10">
            <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-500">
                <div>
                    ...
                    <p className="max-w-[410px] mt-6">We deliver fresh groceries and snacks stright to your door. Trust by thousands,We aim to make your shopping experience simple and afferteble</p>
                </div>
